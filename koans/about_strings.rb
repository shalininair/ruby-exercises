...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    #=> Memory and performance reasons. << modifies the object in-place and hence is faster.
    #=> += creates a new object, using more memory and hence is slower
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # Surprised? #=>it justs gets the character at the given index for the string object, just like array
  end
