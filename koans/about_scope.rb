...
class AboutScope < Neo::Koan
  ...
  def test_you_can_reference_nested_classes_using_the_scope_operator
    ...
    #puts "fido.class is #{fido.class}"
    #puts "rover.class is #{rover.class}"
    #puts "Jims::Dog is #{Jims::Dog}"
    #puts "Joes::Dog is #{Joes::Dog}"
  ...
  def test_you_can_get_a_list_of_constants_for_any_class_or_module
    #puts "Object.constants.size is #{Object.constants.size}"
