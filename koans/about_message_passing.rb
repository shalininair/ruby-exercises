...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    #=> _send_ cannot be overridden (Ruby gives a warning) if you do. 
    #=> While metaprogramming, to be sure that the class will respond to the message, use __send__
    #=> send was created earlier to _send_ and so is also used, but can be overridden without a warning
  end
