...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    #=> * will return nil if the character(s) preceding the asterisked character(s) are not matched in the receiver
    #=> 'noodle'.match /ep*/ will match because vene though the receiver has no ep, it has an 'e' in the fiftn position
    #=> 'noodle'.match /pe*/ will not match and return nil because there is no 'p' character preceding an 'e'    
  end
  ...
  #=> 'neeeedle' =~ /ee*/ will match "eeee". It's the same for 'neeeedle' =~ /ee+/
  ...
  #=> A character class will match against one of characters in it, whereas alternation matches the entire string 
  #=> E.g."James Gray"[/[James] Gray/] will match "s Gray", whereas "James Gray"[/(James|Dana|Summer) Gray/] will match "James Gray"
  # ------------------------------------------------------------------
